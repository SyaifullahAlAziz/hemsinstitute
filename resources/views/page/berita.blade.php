					...
					<div class="courses_container">
						<div class="row courses_row">
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									<div class="course_image"><img src="{{ asset('images/berita/' . $data->gambar) }}" width="100%" height="400px" alt=""></div>
									<div class="course_body">
										<h3 class="course_title"><a href="{{ route('detail-berita',$data->slug) }}">{{ $data->judul }}</a></h3>
						...
						<div class="sidebar_section">
							...
							<div class="sidebar_categories">
								<ul>
									...
									<li><a href="{{ route('detail-berita',$data->slug) }}">
										{{ $data->judul }}
									</a></li>
									@endforeach
								</ul>
