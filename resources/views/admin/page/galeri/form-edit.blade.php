...
<div class="container-fluid">
    <div class="card">
        ...
        <form class="form-horizontal" action="{{ route('update-persyaratan-program', $editData->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="judul" id="judul" value="{{ $editData->judul }}" required class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
